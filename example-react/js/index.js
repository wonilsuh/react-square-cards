		...
		var Card = function (_React$Component) {
			...
			(0, _createClass3.default)(Card, [{
				...
				value: function render() {
					return _react2.default.createElement(
						'div',
						{ className: 'react-square-card ' + (this.props.className ? this.props.className : '') },
						_react2.default.createElement(
							'div',
							{ className: 'react-square-card-inner', style: {
									paddingTop: (this.props['aspect-ratio-width'] || 1) / (this.props['aspect-ratio-height'] || 1) * 100 + '%'
								} },
							_react2.default.createElement(
								'div',
